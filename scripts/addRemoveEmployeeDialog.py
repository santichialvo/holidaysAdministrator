...
class addRemoveEmployeeDialog(QtWidgets.QDialog):
    ...
    def addEmployee(self):
        ...
        if Res:
            ...
            Rta = QtWidgets.QMessageBox.question(self,'Confirmación','¿Desea incorporar a '+nombre+' '+apellido+' al sistema?',QtWidgets.QMessageBox.Yes,QtWidgets.QMessageBox.No)
            if (Rta==QtWidgets.QMessageBox.Yes):
                ...
                if (Res==0):
                    ...
                    if (Res!=0):
                        QtWidgets.QMessageBox.critical(self,'Error '+str(Res),'Error creando los roles para el nuevo usuario. Contacte al administrador inmediatamente.')
                        return
                    ...
                    for iPeriod in Periods:
                        ...
                        if (Res!=0):
                            QtWidgets.QMessageBox.critical(self,'Error '+str(Res),'Error creando los dias para el nuevo usuario. Contacte al administrador inmediatamente.')
                            return
                    ...
                    QtWidgets.QMessageBox.critical(self,'Error '+str(Res),'No se pudo realizar la operación solicitada')
            else:
    ...
    def removeEmployee(self):
        ...
        Rta = QtWidgets.QMessageBox.question(self,'Confirmación','¿Desea eliminar al usuario '+employeeStr+' del sistema?',QtWidgets.QMessageBox.Yes,QtWidgets.QMessageBox.No)
        if (Rta==QtWidgets.QMessageBox.Yes):
            ...
            if (Ret==1):
                ...
                QtWidgets.QMessageBox.critical(self,'Error '+str(Ret),'No se pudo realizar la operación solicitada')
        else:
            QtWidgets.QMessageBox.information(self,'Cancelada','Operación cancelada')
        return